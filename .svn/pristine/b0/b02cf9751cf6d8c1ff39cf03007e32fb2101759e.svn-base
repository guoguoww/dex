        ...
        <div class="coin-quotation">
          ...
          <div class="coin-num">
            <div class="coin-num-left">
              ...
              <span>{{market.price}}
                <em>{{coinitem.unitsCode}}</em>
              </span>
              <p>{{Number(market.diff).toFixed(+market.precision)}}
                <em>{{Number(market.diffRate).toFixed(+market.precision)}}%</em>
              </p>
              <!-- <b>24h成交量 0.00 ETH</b> -->
            </div>
          ...
          <div class="coin-chart">
            ...
            <div id="kline_container" >
                ...
                <table id="fs">
                  <tbody>
                    <tr>
                      <td class="kline_td  " :class="{'chart-active':intervalact===i.code }" v-for="(i,index) in interval" :key="index" @click="intervalact=i.code">{{i.name}}</td>
                    </tr>
                  </tbody>
                </table>

            <trading-view :code='coinitem.marketCode' :market='market' height='250px' :interval='intervalact' :study='study'></trading-view>
                <table id="fs1">
                  <tbody>
                    <tr>
                        <td class="kline_td " :class="{'chart-active':study.name===i.name }" v-for="(i,index) in studys" :key="index" @click="study=i">{{i.name}}</td>
                    </tr>
                  </tbody>
                </table>
            <!-- 最新成交 -->
        ...
        return {
            ...
            studys:[
                ...
                },
                {
                    ...
                    style:{
                            'Plot.color': 'rgb(142,21,153)'
                    }
                },
                {
                    name:'DMI',
                    code:'Directional Movement',
                    style:{
                            'ADX.color': 'rgb(255,0,110)',
                            '+DI.color': 'rgb(0,148,255)',
                            '-DI.color': 'rgb(255,106,0)'
                    }
                },
                // {
                //     name:'OBV',
                //     code:'On Balance Volume',
                //     style:{
                //             'Plot.color': 'rgb(142,21,153)'
                //     }
                // },
                {
                    name:'ASI',
                    code:'Accumulative Swing Index',
                },
                {
                    name:'BOP',
                    code:'Balance of Power',
                },
                {
                    name:'DC',
                    code:'Donchian Channels',
                    style:{
                            'Upper.color': 'rgba(37,255,254,0.7)',
                            'Lower.color': 'rgba(37,255,254,0.7)',
                            'Plots Background.color': 'rgba(212,231,207,0.15)'
                    }
                },
                // {
                //     name:'EOM',
